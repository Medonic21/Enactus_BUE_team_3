...
class _ExpenseScreenState extends State<ExpenseScreen> {
  ...
  void _showAddExpenseDialogue(){
    showDialog(context: context, builder: AddExpenseDialogue(onAddExpense: _addExpense),);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Today's Exoenses"),
      ),
...
class AddExpenseDialogue extends StatefulWidget {
  ...
  @override
  State<AddExpenseDialogue> createState() {
    return _AddExpenseDialogueState();
  }
}
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          TextField(controller: _titleController, decoration: const InputDecoration(labelText: 'Expense'),),
